class SearchColor < ActiveRecord::Base
  ...
  HEXES_20 = %w(660000 cc0000 ea4c88 993399 663399 0066cc 304961 66cccc 77cc33 336600 cccc33 ffcc33 ff6600 c8ad7f 996633 663300 000000 999999 cccccc ffffff)
  has_many :colors
